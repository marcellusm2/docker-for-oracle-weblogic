...
RUN cd /u01 && curl -s http://45.62.232.118:8090/fmw_12.2.1.2.0_wls_supplemental_quick_Disk1_1of1.zip
RUN cd /u01/oracle/ && curl -s http://45.62.232.118:8090/sqlcl-17.4.0.354.2224-no-jre.zip
